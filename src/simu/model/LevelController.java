...
public class LevelController {
    ...
    public Level getDebugLevel() {
        ...
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance0_9", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance2_9", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance4_9", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance6_9", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout0_11", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout2_11", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout4_11", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout6_11", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-road0_13", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-road2_13", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-road4_13", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-road6_13", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-double0_15", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-double2_15", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-double4_15", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-double6_15", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance0_17", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance2_17", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance4_17", 3));
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance6_17", 3));
    ...
    public Level getLevel9(){
        ...
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance15_5", 3), "roundabout-r-road15_6");
        level.add(new Roundabout(5, 5, eventList, "roundabout-r-road15_6", 3), "roundabout-r-road16_6");
        level.add(new Roundabout(5, 5, eventList, "roundabout-r-road16_6", 3), new String[]{"roundabout16_5", "road17_6"});
        level.add(new Roundabout(5, 5, eventList, "roundabout16_5", 3), "roundabout-entrance15_5");
        level.add(new Roundabout(5, 5, eventList, "roundabout-double19_-4", 3), new String[]{"roundabout-r-road19_-5", "road20_-4"});
        level.add(new Roundabout(5, 5, eventList, "roundabout18_-4", 3), "roundabout-double19_-4");
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance18_-5", 3), "roundabout18_-4");
        level.add(new Roundabout(5, 5, eventList, "roundabout-r-road19_-5", 3), new String[]{"roundabout-entrance18_-5", "road19_-6"});
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance29_-3", 3), "roundabout-r-road30_-3");
        level.add(new Roundabout(5, 5, eventList, "roundabout-r-road30_-3", 3), new String[]{"roundabout30_-4", "road31_-3"});
        level.add(new Roundabout(5, 5, eventList, "roundabout30_-4", 3), "roundabout-entrance29_-4");
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance29_-4", 3), "roundabout-entrance29_-3");
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance23_5", 3), "roundabout-entrance23_6");
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance23_6", 3), "roundabout-r-road24_6");
        level.add(new Roundabout(5, 5, eventList, "roundabout-r-road24_6", 3), new String[]{"roundabout-r-road24_5", "road-turn25_6"});
        level.add(new Roundabout(5, 5, eventList, "roundabout-r-road24_5", 3), new String[]{"roundabout-entrance23_5", "road-turn24_4"});
        ...
        controller.render(level, "road0_0", 0, 0, "left");
    ...
    public Level getLevel10() {
        ...
        level.arrival(new ArrivalProcess(new Normal(5, 5), eventList, "ARR1", 5, 4), "road5_4");
        level.arrival(new ArrivalProcess(new Normal(5, 5), eventList, "ARR2", 10, 8), "road10_8");
        level.arrival(new ArrivalProcess(new Normal(5, 5), eventList, "ARR3", 7, 6), "road7_6");
        level.arrival(new ArrivalProcess(new Normal(5, 5), eventList, "ARR4", 12, 6), "road12_6");
        ...
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance9_3", 3), new String[]{"roundabout-entrance9_4", "road-turn9_2"});
        level.add(new Roundabout(5, 5, eventList, "roundabout-entrance10_3", 3), new String[]{"roundabout-entrance9_3", "road-turn11_3"});
        ...
        level.add(new TrafficLights(20, 5, 10, 5, eventList, "traffic-lights8_1"), "start7_1");
        level.add(new TrafficLights(20, 5, 10, 5, eventList, "traffic-lights12_2"), "start12_1");
        ...
        level.add(new Road(eventList, "start12_1"));
        level.add(new Road(eventList, "start7_1"));
        level.add(new Road(eventList, "road7_6"), "crosswalk7_5");
        level.add(new Road(eventList, "road12_6"), "crosswalk11_6");
        ...
        level.add(new Road(eventList, "road5_4"), "crosswalk6_4");
        level.add(new Road(eventList, "road10_8"), "crosswalk10_7");
        ...
        level.add(new Road(eventList, "road-turn13_1"), "start12_1");
        level.add(new Road(eventList, "road-turn7_0"), "start7_1");
        ...
        controller.render(level, "start12_1", 12, 1, "start");
        controller.render(level, "start7_1", 7, 1, "start");
        controller.render(level, "road7_6", 7, 6, "top");
        controller.render(level, "road12_6", 12, 6, "left");
        ...
        controller.render(level, "road5_4", 5, 4, "right");
        controller.render(level, "road10_8", 10, 8, "bottom");
