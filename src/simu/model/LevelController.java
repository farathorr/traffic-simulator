...
public class LevelController {
    ...
    public Level getLevel1() {
        ...
        level.add(new Roundabout(5, 5, eventList, "roundabout-road4_2", 3), "roundabout-road5_2");
        level.add(new Roundabout(5, 5, eventList, "roundabout-road5_2", 3), "roundabout-road5_1");
        level.add(new Roundabout(5, 5, eventList, "roundabout-road5_1", 3), "roundabout-road4_1");
        level.add(new Roundabout(5, 5, eventList, "roundabout-road4_1", 3), new String[]{"roundabout-road4_2", "goal3_1"});
