...
//        level.arrival(new ArrivalProcess(new Normal(5, 5), eventList, "ARR1", 0, 0), "road0_0");
    ...
    public Level getLevel6() {
        ...
        level.arrival(new ArrivalProcess(new Normal(5, 5), eventList, "ARR1", 3, 0), "road-turn9_0");

        level.add(new Road(eventList, "road-turn9_0"), "road9_1");
        level.add(new Road(eventList, "road-turn9_3"), "road8_3");
        level.add(new Road(eventList, "road-turn5_3"), "road-turn5_2");
        level.add(new Road(eventList, "road-turn5_2"), "road4_2");
        level.add(new Road(eventList, "road-turn1_2"), "road1_3");
        level.add(new Road(eventList, "road-turn1_6"), "road2_6");
        level.add(new Road(eventList, "road-turn9_6"), "road9_7");
        level.add(new Road(eventList, "road-turn9_9"), "road8_9");
        level.add(new Road(eventList, "road8_0"), "road-turn9_0");
        level.add(new Road(eventList, "road7_0"), "road8_0");
        level.add(new Road(eventList, "road5_0"), "road6_0");
        level.add(new Road(eventList, "road4_0"), "road5_0");
        level.add(new Road(eventList, "road3_0"), "road4_0");
        level.add(new Road(eventList, "road2_2"), "road-turn1_2");
        level.add(new Road(eventList, "road3_2"), "road2_2");
        level.add(new Road(eventList, "road4_2"), "road3_2");
        level.add(new Road(eventList, "road2_6"), "road3_6");
        level.add(new Road(eventList, "road3_6"), "road4_6");
        level.add(new Road(eventList, "road5_6"), "road6_6");
        level.add(new Road(eventList, "road6_6"), "road7_6");
        level.add(new Road(eventList, "road7_6"), "road8_6");
        level.add(new Road(eventList, "road8_6"), "road-turn9_6");
        level.add(new Road(eventList, "road4_6"), "road5_6");
        level.add(new Road(eventList, "road1_5"), "road-turn1_6");
        level.add(new Road(eventList, "road1_4"), "road1_5");
        level.add(new Road(eventList, "road1_3"), "road1_4");
        level.add(new Road(eventList, "road9_2"), "road-turn9_3");
        level.add(new Road(eventList, "road9_1"), "road9_2");
        level.add(new Road(eventList, "road9_8"), "road-turn9_9");
        level.add(new Road(eventList, "road9_7"), "road9_8");
        level.add(new Road(eventList, "road6_0"), "road7_0");
        level.add(new Road(eventList, "road6_3"), "road-turn5_3");
        level.add(new Road(eventList, "road7_3"), "road6_3");
        level.add(new Road(eventList, "road8_3"), "road7_3");
        level.add(new Road(eventList, "road8_9"), "road7_9");
        level.add(new Road(eventList, "road7_9"), "road6_9");
        level.add(new Road(eventList, "road6_9"), "road5_9");
        level.add(new Road(eventList, "road5_9"), "goal4_9");
